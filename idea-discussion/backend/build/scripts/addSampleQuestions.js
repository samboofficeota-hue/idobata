...
const connectDB = async () => {
    try {
        const mongoUri = process.env.MONGODB_URI || "mongodb://localhost:27017/idobata";
...
const sampleQuestions = [
    ...
    {
        questionText: "どうすれば、教育格差を解消し、全ての子供が質の高い教育を受けられる社会を実現できるのか？",
        tagLine: "教育・格差",
        tags: ["教育", "格差", "平等"],
        themeId: null,
    },
    {
        questionText: "どうすれば、デジタルデバイドを解消し、高齢者も含めて全ての人がデジタル技術を活用できる社会を作れるのか？",
        tagLine: "デジタル・高齢者",
        tags: ["デジタル", "高齢者", "技術格差"],
        themeId: null,
    },
    {
        questionText: "どうすれば、働き方改革を進めながら、労働者の権利と企業の競争力を両立できるのか？",
        tagLine: "働き方改革・労働",
        tags: ["働き方改革", "労働", "企業"],
        themeId: null,
    },
...
const addSampleQuestions = async () => {
    try {
        ...
        for (const question of result) {
            console.log(`- ${question.tagLine}: ${question.questionText.substring(0, 50)}...`);
        }
    }
    catch (error) {
...
// スクリプトを実行
addSampleQuestions();
//# sourceMappingURL=addSampleQuestions.js.map